...
console.log()
console.log('NUXT_AUTH_PASSWORD_HASH_BASE64 — use this instead (leave NUXT_AUTH_PASSWORD_HASH')
console.log('unset) if your deployment platform\'s env var UI mangles `$` — e.g. its own')
console.log('${...}-style templating, or silently trimming/wrapping the value. No special')
console.log('characters, so nothing to escape:')
